        ...
        <section id="servicos" className="bg-ebano w-full section-h flex items-center justify-center ">
            <div className="container flex flex-col items-center py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full h-auto">
                    ...
                    <GridInfo icon={Bolsa} title="Capas & Estojos" description="Proteção com estilo. Capas para notebook, tablet e livros, estojos e necessaires com estrutura pensada para o dia a dia e estética que combina com você." />
